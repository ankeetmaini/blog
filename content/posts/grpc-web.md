...
{% image "../../img/grpc-call.png", "" %}

If you look at the network call you won't find your friendly old `json`, but some binary gibberish!

{% image "../../img/grpc-req.png", "request payload of a grpc call" %}

And same on the response too.

{% image "../../img/grpc-response.png", "grpc response in devtools" %}
...
{% image "../../img/arch-grpc.png", "architecture of grpc" %}
...
{% image "../../img/grpc-obj.png", "grpc object in js" %}
