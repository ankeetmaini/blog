...
# one single bundle <Text>(easy-peasy to sove with code-splitting)</Text>
...
<Appear>
  <div><Center>roses are red</Center></div>
  <div><Center>violets are blue</Center></div>
  <div><Center>isn't there a ...</Center></div>
  <div><Center>Webpack plugin which would do!</Center></div>
  <h1><Text><Center>Nooooooooooo! 😭😭😭</Center></Text></h1>
</Appear>
